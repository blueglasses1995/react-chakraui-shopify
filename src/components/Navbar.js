...
const Navbar = () => {
  ...
  return (
    <Box borderBottom="0.25pt white solid" backgroundColor="#FFA8E2" display="flex" flexDir="row" p="1rem" justifyContent="space-between" alignItems="center" position="fixed" width="100%" zIndex={100}>
      <Icon fill="white" cursor="pointer" onClick={() => openMenu()} as={MdDehaze} w={30} h={30}></Icon>
      <Link to="/"><Image src="https://cdn.shopify.com/s/files/1/0472/5705/9496/files/Logologo_1.svg?v=1610055540" w={50} h={50}/></Link>
      <Box>
